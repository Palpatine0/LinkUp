...
<div>
    ...
    <canvas canvas-id="oper-canvas" id="oper-canvas" class="oper-canvas" :style="{top: sT, height: csH}" disable-scroll="false" @touchstart="fStart" @touchmove="fMove" @touchend="fEnd"></canvas>
    ...
    <div class="tab-bar-wrapper" :style="{display: sD, top:tp}">
        <div class="tab-bar">
            <div class="btn-wrapper">
                <div @click="fClose" hover-class="hover">
                    <div><img class="btn" src="/static/page/component/avatar-cropper/xmark.svg"></div>
                </div>
                <!--<div @click="fSelect" hover-class="hover" :style="{width: bW}"><div>重选</div></div>-->
                <div @click="fRotate" hover-class="hover">
                    <div><img class="btn" src="/static/page/component/avatar-cropper/rotate-right.svg"></div>
                </div>
                <div @click="fUpload" hover-class="hover">
                    <div><img class="btn" src="/static/page/component/avatar-cropper/circle-check.svg"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        ...
        fUpload() {
            ...
            uni.canvasToTempFilePath({
                ...
                quality: this.qlty,
                success: (r) => {
                    this.$emit("upload", {path: r.tempFilePath});
                },
                fail: () => {
                    uni.showToast({title: "Failed to process image", duration: 2000});
                },
                complete: () => {
                    uni.hideLoading();
